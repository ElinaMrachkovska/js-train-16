...
function filterStudentsByGrade(students, grade) {
  ...
  if (filteredStudents.length) {
    ...
    console.log(`Студентів з оцінкою "${grade}" не знайдено.`);
  }
}
...
function countVowelsAndConsonants(word) {
  ...
  console.log(`Голосних: ${newRowCount}`);
  console.log(`Приголосних: ${Count}`);
}
